...
import com.example.JobPortalProject.services.JobSeekerSaveService;
...
public class JobPostActivityController {
    ...
    public String searchJobs(Model model,
        ...
        // 1. Kiểm tra Null cho Boolean để tránh NullPointerException
        today = (today != null && today);
        days7 = (days7 != null && days7);
        days30 = (days30 != null && days30);

        // 2. Add attributes cho model để giữ trạng thái checkbox trên giao diện
        ...
        // Logic mặc định cho Job Type và Remote
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (authentication.getAuthorities().contains(new SimpleGrantedAuthority("Recruiter"))) {
                ...
                // Xử lý cho JobSeeker: Check xem Job đã Apply hay Save chưa
                List<JobSeekerApply> jobSeekerApplyList = jobSeekerApplyService.getCandidatesJobs((JobSeekerProfile) currentUserProfile);
                List<JobSeekerSave> jobSeekersSaveList = jobSeekerSaveService.getCandidatesJob((JobSeekerProfile) currentUserProfile);
                ...
                for (JobPostActivity jobActivity : jobPost) {
                    ...
                    boolean saved = jobSeekersSaveList.stream()
    ...
    @GetMapping("/dashboard/edit/{id}") // Chuyển từ Post sang Get để đúng chuẩn edit
